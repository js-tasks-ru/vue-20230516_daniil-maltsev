<template>
  <form class="meetup-form" @submit.prevent="submit">
    <div class="meetup-form__content">
      ...
      <meetup-agenda-item-form v-for="({ id }, index) in localMeetup.agenda"
        :key="id"
    ...
    <div class="meetup-form__aside">
      <div class="meetup-form__aside-stick">
        ...
        <ui-button variant="secondary" block class="meetup-form__aside-button" @click="handleCancel" data-test="cancel">Отмена</ui-button>
